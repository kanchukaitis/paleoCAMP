...
The links above take you to the files in this repository.  Each notebook has a button at the top that will open it in Google CoLabs, the platform we use during paleoCAMP.  Alternatively, the following links open the notebooks directly in CoLabs:
